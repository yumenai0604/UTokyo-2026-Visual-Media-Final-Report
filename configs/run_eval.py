...
data_root = os.environ.get('SARDET_DATA_ROOT', '/path/to/SARDet_100K/')
ann_file = os.environ.get('SARDET_ANN_FILE', 'Annotations/test.json')
image_prefix = os.environ.get('SARDET_IMG_PREFIX', 'JPEGImages/test/')
backend_args = None
